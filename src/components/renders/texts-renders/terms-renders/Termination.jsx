...
const Termination = () => {
  return (
    ...
    >
      ...
      >
        11. {TermsOfService[1].sectionheadline[10]}
      </h2>
      ...
      >
        {TermsOfService[1].secondheadlines[2][0]}
      </h3>
      <TextLinksToPages
      ...
      >
        {TermsOfService[1].secondheadlines[2][1]}
      </h3>
      <Paragraph>{TermsOfService[1].textundersecondheadlines[6][1]}</Paragraph>
    </div>
  );
};
